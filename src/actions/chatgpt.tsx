...
export const generateCreativePrompt = async (
  ...
  const finalPrompt = `
    ...
    The outline should consist of at least ${noOfCards} points, with each point written as 4-5 sentences. The language returned should be what the language of the prompt is.
    Ensure the outline is well-structured and directly related to the topic. 
    Return the output in the following JSON format:
  
    {   
     "outlines": [
        ${Array.from({ length: noOfCards }, (_, i) => `"Point ${i + 1}"`)}
